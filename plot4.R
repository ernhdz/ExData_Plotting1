...
png(file = "plot4.png")
par(mfcol = c(2, 2))
plot(x = dataToUse$Time, y = dataToUse$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")

with(dataToUse, plot(x = Time, y = Sub_metering_1, type = "l", col = "black", xlab = "", ylab = "Energy sub metering"))
...
with(dataToUse, plot(x = Time, y = Voltage, type = "l", xlab = "datetime", ylab = "Voltage"))

with(dataToUse, plot(x = Time, y = Global_reactive_power, type = "l", xlab = "datetime"))
dev.off()
